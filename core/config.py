...
AI_BACKENDS = {
    ...
    "antigravity": {"type": "cli",           "cmd": _find_cli("antigravity", "ANTIGRAVITY_CMD"), "args": ["-y", "-p"],                                                         "native_web_search": True, "label": "Antigravity CLI",  "env_key": None},
    ...
    "antigravity-api": {"type": "api_antigravity", "api_key": os.environ.get("ANTIGRAVITY_API_KEY", ""), "model": os.environ.get("ANTIGRAVITY_MODEL", "antigravity-3-flash-preview"),                                   "label": "Antigravity API",   "env_key": "ANTIGRAVITY_API_KEY"},
